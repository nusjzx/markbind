...
module.exports = {
  ...
  isMarkbind: filePath => path.extname(filePath) === '.mbd',
  isMarkbindFragment: filePath => path.extname(filePath) === '.mbdf',
  isSourceFile(filePath) {
    return this.isMarkdown(filePath) || this.isHtml(filePath) || this.isMarkbind(filePath)
      || this.isMarkbindFragment(filePath);
  },
